function [xActual,u_k,du,D,convergence_flag,v_k,theta_k,isValid_flag,fval] = run_simulation_GA(xActual,u_k,du,total_sim_iter,v_k,theta_k,dT,sys,mpc,i_ref,D,c,N,refTrajectory,unicycle,x_ref,y_ref)
    % loop 
    convergence_flag = 0;
    isValid_flag = 0;
    ...
    [du(:,end+1),fval] = run_MPC_GA(sys,mpc,x_kplus1_tilde,extracted_refTrajectory);
