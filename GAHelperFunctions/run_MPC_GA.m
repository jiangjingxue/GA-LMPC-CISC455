function [du_optimal,fval] = run_MPC_GA(sys,mpc,x_kplus1_tilde,extracted_refTrajectory)
    ...
    [du_star,fval] = quadprog(H,fT,A,b,Aeq,beq,lb,ub,x0,optimset('Display', 'off'));          % du_optimal is a column vector
